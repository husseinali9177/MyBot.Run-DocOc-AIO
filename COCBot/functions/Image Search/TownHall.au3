...
Func townHallCheck($check = False)
	...
	If $check = True Or _
		...
		For $i = 0 To 1
			...
			If $i = 0 Then $aTownHall = returnHighestLevelSingleMatch(@ScriptDir & "\imgxml\Resources\TH")
			If $i = 1 Then $aTownHall = returnHighestLevelSingleMatch(@ScriptDir & "\imgxml\Resources\TH2")
			...
			_GDIPlus_ImageDispose($editedImage)
